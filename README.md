...
>
> Analytics app in the DClaw Stack. Built with Next.js, FastAPI, PostgreSQL, and the DKube Design System.

[![Status](https://img.shields.io/badge/status-P4%20Planned-14B8A6)](https://github.com/dclawstack/dclaw-data)
[![Stack](https://img.shields.io/badge/stack-Next.js%2014%20%2B%20FastAPI%20%2B%20PostgreSQL-purple)](https://docs.dclawstack.io/apps/data)

---

## Overview

DClaw Data is an AI-native analytics application. It follows the standard DClaw architecture:
...
DClaw Data uses the **DKube Design System** with its app-specific brand color.
...
```bash
git clone https://github.com/dclawstack/dclaw-data.git
cd dclaw-data
```
...
export DATABASE_URL="postgresql+asyncpg://postgres:postgres@localhost:5432/dclaw_data"
...
```bash
ssh root@your-vps
git clone https://github.com/dclawstack/dclaw-data.git /opt/dclaw-data
cd /opt/dclaw-data
docker compose up -d
```

The app will be available at `https://data.dclawstack.io`.
...
helm upgrade --install dclaw-data . \
...
- [Docs](https://docs.dclawstack.io/apps/data)
