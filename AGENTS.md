...
**DClaw Data** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8026` (FastAPI)
- **Frontend Port:** `3026` (Next.js)
- **Database:** `dclaw_data` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3026`
