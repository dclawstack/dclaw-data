...
### Can I run DClaw Data without Kubernetes?

Yes, for local development:

```bash
cd dclaw-data/frontend && npm run dev
cd dclaw-data/backend && uvicorn dclaw_data.main:app --reload
```
